module.exports = {
    ...
    *版本 V1.0
    */
    requestJSON : function(url,type,async,data,authval,succesfn,errorfn){
        this.ajaxRequest({
            url:url,
            type:type,
    ...
    /*
    *功能描述：post json数据到服务器无token
    *参数描述：
    *作者：txd
    *版本 V1.0
    *创建日期：2018-01-23
    */
    requestJSONNoAuth : function(url,type,async,data,authval,succesfn,errorfn){
        this.ajaxRequest({
            url:url,
            type:type,
            dataType:"json",
    ...
    ajaxRequest : function(options){
        ...
        var url = options.url || "", //请求的链接
            ...
            authorization = options.authorization || "", //请求的类型
