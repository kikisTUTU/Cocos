...
cc.Class({
    ...
    start () {
        ...
        for(let i = 0; i<this.moveObjs.length; i++){
            ...
            let seq = cc.sequence(cc.delayTime(internalT), cc.moveTo(this.moveTimes[i], this.movePositions[i]));
        ...
        let seq1 = cc.sequence(cc.delayTime(this.totalTime),cc.callFunc(function(){
            ...
            // console.log("我可以被点击了吗"+ config.isActionTimes+"   "+config.isActionFinished);
        },this));
